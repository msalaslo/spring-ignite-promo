...
import com.msl.ignite.promo.service.MarcaService;
...
public class MarcaController {
    ...
    public Optional<Marca> findByid(@RequestParam(value="id", required=false, defaultValue="0") String id, Model model) {
