...
import com.msl.ignite.promo.service.EmpresaService;
...
public class EmpresaController {
    ...
    public Optional<Empresa> findByid(@RequestParam(value="id", required=false, defaultValue="0") String id, Model model) {
