package com.msl.ignite.promo.controller;
...
import com.msl.ignite.promo.service.FamiliaService;
...
public class FamiliaController {
    ...
    public Optional<Familia> findByid(@RequestParam(value="id", required=false, defaultValue="0") String id, Model model) {
