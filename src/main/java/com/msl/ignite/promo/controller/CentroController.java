...
import com.msl.ignite.promo.service.CentroService;
...
public class CentroController {
    ...
    public Optional<Centro> findByid(@RequestParam(value="id", required=false, defaultValue="0") String id, Model model) {
